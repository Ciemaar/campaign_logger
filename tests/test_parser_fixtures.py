...
def test_parse_log_entry_from_fixture():
    ...
    assert (
        entry.raw_text
        == '@Unicorn takes up residence near @"Lillian Robin" after she purifies her home and part of #"Fork State Park"  in the *"Psychic Storm Of Purification"'  # noqa: E501
    )
