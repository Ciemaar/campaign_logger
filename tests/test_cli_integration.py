...
def mock_client(mocker):
    ...
    mock_instance.get_generator.return_value = FullGeneratorModel(
        id="1",
        name="Gen 1"
    )
    mock_instance.create_generator.return_value = FullGeneratorModel(
        id="3",
        name="New Gen"
    )
    mock_instance.update_generator.return_value = FullGeneratorModel(
        id="1",
        name="Updated Gen"
    )
    ...
    mocker.patch(
        'campaign_logger.cli.GeneratorClient',
