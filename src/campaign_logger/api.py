...
class LoggerClient:
    ...
    def _get(self, resource_type: str, item_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    def create_campaign(self, title: str, description: str = "") -> Dict[str, Any]:
    ...
    def update_campaign(self, campaign_id: str, title: Optional[str] = None, description: Optional[str] = None) -> Dict[str, Any]:
    ...
    def create_log(self, campaign_id: str, title: str, description: str = "") -> Dict[str, Any]:
    ...
    def update_log(self, log_id: str, title: Optional[str] = None, description: Optional[str] = None) -> Dict[str, Any]:
    ...
    def update_log_entry(self, entry_id: str, raw_text: str) -> Dict[str, Any]:
    ...
    def get_campaign_entries(self) -> Dict[str, Any]:
        return self._get("campaign-entries")

    def get_campaign_entry(self, entry_id: str) -> Dict[str, Any]:
        return self._get("campaign-entries", entry_id)

    def create_campaign_entry(self, campaign_id: str, raw_text: str) -> Dict[str, Any]:
    ...
    def update_campaign_entry(self, entry_id: str, raw_text: str) -> Dict[str, Any]:
